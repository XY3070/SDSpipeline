...
OUT_ROOT="$SDS_DATA_PROCESSED_ROOT/sds_output_scn_olddefault_genomewide_hybridpolicy_20260531"
...
STATE_DIR="$SDS_RUNS_ROOT/scn_olddefault_genomewide_hybridqarm_submitter_array_$TS"
