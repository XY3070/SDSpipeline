...
OUT_ROOT="$BASE_DIR/data/processed/sds_output_ncn_olddefault_gw_relaxed035_smiss10_20260605"
IN_ROOT="$BASE_DIR/data/processed/sds_input_rebuilt_main_contract_20260511"
G_FILE="$BASE_DIR/tmp/ncn_smcppquick_smokegrid_20260526/gravel_chb_present87282.g_file.txt"
...
STATE_DIR="$BASE_DIR/data/processed/ncn_olddefault_gw_relaxed035_submitter_array_$TS"
