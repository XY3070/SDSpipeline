...
COMPUTE_ARRAY_CAP="6"
SMOKE_CHR="10"
INPUT_ROOT="$SDS_DATA_PROCESSED_ROOT/sds_input_rebuilt_main_contract_20260511"
SMOKE_OUT_ROOT="$SDS_DATA_PROCESSED_ROOT/sds_output_gravel_chb_ne100k_smoke_20260511"
OUT_ROOT="$SDS_DATA_PROCESSED_ROOT/sds_output_gravel_chb_ne100k_newinput_20260511"
TS="$(date +%Y%m%d_%H%M%S)"
MANIFEST_DIR="$SDS_RUNS_ROOT/gravel_chb_ne100k_newinput_launch_$TS"
