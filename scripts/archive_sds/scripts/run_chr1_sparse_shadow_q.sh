...
SPARSE_T="$BASE_DIR/tmp/chr1_tfile_sparse_like_legacy_20260505/chr1_t_file.txt"
INPUT_DIR="$BASE_DIR/data/processed/sds_input/$POP"
OUT_DIR="$BASE_DIR/tmp/chr1_sparse_shadow_q_20260505"
